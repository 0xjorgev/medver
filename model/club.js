...
, (DB, Models, logger) => {
    var Club = DB.Model.extend({
        ...
        saveClub: function(_club){
        	let _currentUser = _club._currentUser
			let clubData = {}
			...
			.then(result => {
				// logger.debug('Resturn club', result)
