...
heroku pg:reset DATABASE_URL -a ss-core-$herokuenv --confirm ss-core-$herokuenv && heroku run knex migrate:latest -a ss-core-$herokuenv && heroku run knex seed:run -a ss-core-$herokuenv
