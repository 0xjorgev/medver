...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    */
    ...
    knex('phases').insert({name: 'Apertura', position:1, category_id:1, participant_team:4, classified_team:2}),
    knex('phases').insert({name: 'Clausura', position:2, category_id:1, participant_team:2, classified_team:1})
  );
};
