...
//var tableName = ''subdisciplines'';
  return Promise.join(
    ...
    knex('subdisciplines').insert({name: 'Soccer', description:"Association football, more commonly known as football or soccer,[3] is a sport played between two teams of eleven players with a spherical ball.", discipline_id:1, image_url:'http://dev.codefuel.me/smsmedia/somosport-vector-icons-futbol-4.svg'}),
    knex('subdisciplines').insert({name: 'Beach Soccer', description:"Beach soccer, also known as beach football or beasal, is a variant of association football played on a beach or some form of sand.", discipline_id:1, image_url:'http://dev.codefuel.me/smsmedia/somosport-vector-icons-futbol-2.svg'}),
