...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    */
    ...
    knex('phases').insert({id: 1, name: 'Apertura', position:0, category_id:1, participant_team:4, classified_team:2}),
    knex('phases').insert({id: 2, name: 'Clausura', position:1, category_id:1, participant_team:2, classified_team:1})
  );
};
