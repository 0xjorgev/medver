...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    //Team 1
    knex('players_teams').insert({player_id:1, team_id:4}),
    knex('players_teams').insert({player_id:2, team_id:4}),
    knex('players_teams').insert({player_id:3, team_id:4}),
    knex('players_teams').insert({player_id:4, team_id:4}),
    knex('players_teams').insert({player_id:5, team_id:4}),
    knex('players_teams').insert({player_id:6, team_id:4}),
    knex('players_teams').insert({player_id:7, team_id:4}),
    knex('players_teams').insert({player_id:8, team_id:4}),
    knex('players_teams').insert({player_id:9, team_id:4}),
    knex('players_teams').insert({player_id:10, team_id:4}),
