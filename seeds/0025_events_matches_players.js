...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    */
    ...
    // Inserts seed entries
    knex('events_matches_players').insert({match_id:5, event_id:7, player_in:null, player_out:null}),
    knex('events_matches_players').insert({match_id:5, event_id:9, player_in:null, player_out:null}),
    knex('events_matches_players').insert({match_id:5, event_id:2, player_in:2, player_out:null}),
    knex('events_matches_players').insert({match_id:5, event_id:2, player_in:16, player_out:null}),
    knex('events_matches_players').insert({match_id:5, event_id:1, player_in:16, player_out:null}),
    knex('events_matches_players').insert({match_id:5, event_id:5, player_in:17, player_out:16}),
    knex('events_matches_players').insert({match_id:5, event_id:10, player_in:null, player_out:null}),
    knex('events_matches_players').insert({match_id:5, event_id:9, player_in:null, player_out:null}),
    knex('events_matches_players').insert({match_id:5, event_id:2, player_in:null, player_out:7}),
    knex('events_matches_players').insert({match_id:5, event_id:1, player_in:5, player_out:null}),
    knex('events_matches_players').insert({match_id:5, event_id:10, player_in:5, player_out:null}),
    knex('events_matches_players').insert({match_id:5, event_id:8, player_in:null, player_out:null})
    );
};