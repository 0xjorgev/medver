...
console.log(__filename.slice(__dirname.length + 1) + ' START')
    ...
    knex('events_matches_players').insert({match_id:10, event_id:1, player_in:111, player_out:null, instant:35, team_id:12 }),
    knex('events_matches_players').insert({match_id:10, event_id:1, player_in:148, player_out:null, instant:43, team_id:14 }),
    ...
    knex('events_matches_players').insert({match_id:10, event_id:1, player_in:134, player_out:null, instant:48, team_id:14 }),
    ...
    knex('events_matches_players').insert({match_id:12, event_id:1, player_in:159, player_out:null, instant:5, team_id:15 }),

    knex('events_matches_players').insert({match_id:12, event_id:1, player_in:79, player_out:null, instant:10, team_id:10 }),
    knex('events_matches_players').insert({match_id:12, event_id:1, player_in:86, player_out:null, instant:15, team_id:10 }),
    ...
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:163, player_out:null, instant:1, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:152, player_out:null, instant:7, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:152, player_out:null, instant:11, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:163, player_out:null, instant:16, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:153, player_out:null, instant:25, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:150, player_out:null, instant:32, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:151, player_out:null, instant:36, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:150, player_out:null, instant:38, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:165, player_out:null, instant:41, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:165, player_out:null, instant:42, team_id:15 }),
    ...
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:165, player_out:null, instant:47, team_id:15 }),
    knex('events_matches_players').insert({match_id:17, event_id:1, player_in:165, player_out:null, instant:50, team_id:15 }),
    ...
    //GOL
    knex('events_matches_players').insert({match_id:11, event_id:1, player_in:90, player_out:null, instant:5, team_id:11 }),
    knex('events_matches_players').insert({match_id:11, event_id:1, player_in:90, player_out:null, instant:10, team_id:11 }),
    knex('events_matches_players').insert({match_id:11, event_id:1, player_in:90, player_out:null, instant:15, team_id:11 }),
    ...
    //GOL
    knex('events_matches_players').insert({match_id:13, event_id:1, player_in:130, player_out:null, instant:5, team_id:13 }),
    knex('events_matches_players').insert({match_id:13, event_id:1, player_in:130, player_out:null, instant:12, team_id:13 }),
    ...
    knex('events_matches_players').insert({match_id:13, event_id:1, player_in:130, player_out:null, instant:49, team_id:13 }),
  ...
  //GOL
  knex('events_matches_players').insert({match_id:14, event_id:1, player_in:91, player_out:null, instant:5, team_id:11 }),
  ...
  knex('events_matches_players').insert({match_id:14, event_id:1, player_in:107, player_out:null, instant:47, team_id:12 }),
  knex('events_matches_players').insert({match_id:14, event_id:1, player_in:107, player_out:null, instant:63, team_id:12 }),
  ...
  //GOL
  knex('events_matches_players').insert({match_id:15, event_id:1, player_in:138, player_out:null, instant:5, team_id:14 }),
  ...
  knex('events_matches_players').insert({match_id:15, event_id:1, player_in:138, player_out:null, instant:47, team_id:14 }),
  knex('events_matches_players').insert({match_id:15, event_id:1, player_in:138, player_out:null, instant:63, team_id:14 }),
  ...
  //GOL
  knex('events_matches_players').insert({match_id:16, event_id:1, player_in:75, player_out:null, instant:5, team_id:10 }),
  ...
  knex('events_matches_players').insert({match_id:16, event_id:1, player_in:75, player_out:null, instant:47, team_id:10 }),
  knex('events_matches_players').insert({match_id:16, event_id:1, player_in:75, player_out:null, instant:63, team_id:10 }),
  ...
  //GOL
  knex('events_matches_players').insert({match_id:18, event_id:1, player_in:107, player_out:null, instant:5, team_id:12 }),
  ...
  knex('events_matches_players').insert({match_id:18, event_id:1, player_in:107, player_out:null, instant:47, team_id:12 }),
  knex('events_matches_players').insert({match_id:18, event_id:1, player_in:107, player_out:null, instant:63, team_id:12 }),
  ...
  //GOL
  knex('events_matches_players').insert({match_id:19, event_id:1, player_in:91, player_out:null, instant:5, team_id:11 }),
  ...
  knex('events_matches_players').insert({match_id:19, event_id:1, player_in:138, player_out:null, instant:63, team_id:14 }),
  ...
  //GOL
  knex('events_matches_players').insert({match_id:20, event_id:1, player_in:72, player_out:null, instant:5, team_id:10 }),
  ...
  knex('events_matches_players').insert({match_id:20, event_id:1, player_in:75, player_out:null, instant:51, team_id:10 }),
  knex('events_matches_players').insert({match_id:20, event_id:1, player_in:76, player_out:null, instant:74, team_id:10 }),
  ...
  //GOL
  knex('events_matches_players').insert({match_id:21, event_id:1, player_in:155, player_out:null, instant:5, team_id:15 }),
  ...
  knex('events_matches_players').insert({match_id:21, event_id:1, player_in:156, player_out:null, instant:47, team_id:15 }),
  knex('events_matches_players').insert({match_id:21, event_id:1, player_in:157, player_out:null, instant:63, team_id:15 }),
